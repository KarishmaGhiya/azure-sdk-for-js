...
import { imdsApiVersion, imdsEndpointPath, imdsHost } from "../../credentials/managedIdentityCredential/constants";

import { MSI, MSIConfiguration } from "../../credentials/managedIdentityCredential/models";
